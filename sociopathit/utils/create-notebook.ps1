...
switch ($NotebookType) {
    "general" {
        ...
        $cells += New-NotebookCell "code" @(
            ...
            "from sociopathit.data.loading import load_all_surveys`n",
            "from sociopathit.data.preparation import prepare_for_analysis`n",
            "from sociopathit.analyses.descriptive import crosstab, group_summary`n",
            "from sociopathit.analyses.regress import ols, logit`n",
            "from sociopathit.visuals.bar import bar`n",
            "from sociopathit.visuals.coef import coef`n",
            "`n",
            "# Display settings`n",
        ...
        $cells += New-NotebookCell "code" @(
            ...
            "from sociopathit.visuals.hist import histogram`n",
            "`n",
            "histogram(`n",
            "    df=df_clean,`n",
            "    x='satisfaction',`n",
    ...
    "regression" {
        ...
        $cells += New-NotebookCell "code" @(
            ...
            "import matplotlib.pyplot as plt`n",
            "`n",
            "from sociopathit.analyses.regress import ols, logit, poisson, compare_models`n",
            "from sociopathit.analyses.pubtable import regression_table`n",
            "from sociopathit.visuals.coef import coef, coef_interactive`n",
            "from sociopathit.visuals.margins import margins, margins_comparison`n",
            "from sociopathit.visuals.residuals import residuals`n",
            "`n",
            "# Load data`n",
    ...
    "textual" {
        ...
        $cells += New-NotebookCell "code" @(
            ...
            "import matplotlib.pyplot as plt`n",
            "`n",
            "from sociopathit.analyses.text_analysis import (`n",
            ...
            ")`n",
            "from sociopathit.visuals.wordcloud import wordcloud`n",
            "from sociopathit.visuals.cooccur import cooccur`n",
            "`n",
            "# Load text data`n",
    ...
    "descriptive" {
        ...
        $cells += New-NotebookCell "code" @(
            ...
            "import seaborn as sns`n",
            "`n",
            "from sociopathit.analyses.descriptive import crosstab, group_summary, correlation_matrix`n",
            "from sociopathit.analyses.pubtable import proportion_table, descriptive_table`n",
            "from sociopathit.visuals.hist import histogram`n",
            "from sociopathit.visuals.boxplot import boxplot`n",
            "from sociopathit.visuals.heatmap import heatmap`n",
            "from sociopathit.visuals.pair import pair`n",
            "`n",
            "# Load data`n",
            "np.random.seed(42)`n",
            "n = 500`n",
    ...
    "causal" {
        ...
        $cells += New-NotebookCell "code" @(
            ...
            "import matplotlib.pyplot as plt`n",
            "`n",
            "from sociopathit.analyses.causal import propensity_score, ipw, diff_in_diff`n",
            "from sociopathit.visuals.coef import coef`n",
            "from sociopathit.visuals.density import kde`n",
            "`n",
            "# Load data`n",
            "np.random.seed(42)`n",
            "n = 1000`n",
    ...
    "longitudinal" {
        ...
        $cells += New-NotebookCell "code" @(
            ...
            "import matplotlib.pyplot as plt`n",
            "`n",
            "from sociopathit.data.longitudinal import detect_longitudinal, align_longitudinal_data, sort_by_wave`n",
            "from sociopathit.analyses.panel import fixed_effects, random_effects, first_difference`n",
            "from sociopathit.visuals.trend import trend`n",
            "from sociopathit.visuals.coef import coef`n",
            "`n",
            "# Load panel data`n",
